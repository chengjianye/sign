...
export default {
  ...
  methods: {
    ...
    addPage() {
      // 生成预付单
      // .supplierProductSkuVoList[0].pid;
      ...
      // console.log("this.skuKey", this.skuKey, this.num);
      // let formData = new FormData();
      // formData.append('orderChannel',4)
      // formData.append('skuPidNums',this.skuPidNums[0])
      request
        .post("/api/open/order/prepare", formdata)
        .then(res => {
          console.log("-------res..", res);
        });
        console.log('this.num...',this.num)
      wx.navigateTo({
        url: "/pages/submission/main?id=" + this.pid + "&num=" + this.num
      });
    },
