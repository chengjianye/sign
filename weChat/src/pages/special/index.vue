<template>
  <div class="box">
     <div class="header">
      <div class="banner">
        <img src="/static/images/Bitmap.png" alt="" mode="widthFix">
      </div>
          <scroll-view
            class="nav"
            scroll-x="true"
...
text-decoration:line-through;
  ...
  .cake_left .left_line,.cake_right .right_line{
    width:34px;
    height:1px;
    background:rgba(72,72,72,1);
    margin: 36px 0 0 0;
  ...
  .cake_left .left_dot,.cake_right .right_dot{
    width:7px;
    height:7px;
    background:rgba(72,72,72,1);
    margin: 33px 0 0 0;
